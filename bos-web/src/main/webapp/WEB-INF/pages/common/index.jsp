...
<script type="text/javascript">
	...
	$(function() {
		...
		// 基本功能菜单加载
		$.ajax({
			url : '${pageContext.request.contextPath}/authAction_findMenu.action',
			type : 'POST',
			dataType : 'text',
		...
		$("#btnEp").click(function(){
			...
			var v2=$("#txtRePass").val();
				if(v1==v2){
					$.post("userLogin_editPassword.action",{"password":v1},function(data){
						if(data=="1"){
							//修改成功关闭修改密码窗口
							$("editPwdWindow").window("close");
						}else{
	...
	function logoutFun() {
		...
		.confirm('系统提示','您确定要退出本次登录吗?',function(isConfirm) {
			if (isConfirm) {
				location.href = '${pageContext.request.contextPath }/userLogin_logout.action';
			}
		});
	}
	// 修改密码
