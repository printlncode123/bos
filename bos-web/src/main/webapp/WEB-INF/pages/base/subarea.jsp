	...
	$(function(){
		...
		//根据条件查询
			$("#btn").click(function(){
					...
					/* $("#grid").datagrid("load",$("#searchForm").serialize()); */
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="height:31px;overflow:hidden;" split="false" border="false" >
			<div class="datagrid-toolbar">
				...
				$(function(){
					$("#save").click(function(){
						//校验表单是否为空
						var r=$("#addSubarea").form("validate");
						if(r){//如果表单数据不为空就提交表单刷新页面
							$("#addSubarea").submit();
						}
						});
				});
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="addSubarea" action="subareaAction_add.action" method="post">
	...
	<!-- 显示饼状图 -->
	<div class="easyui-window" title="分区饼状图" id="showWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
