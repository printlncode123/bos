...
<script type="text/javascript">
	$(function(){
		...
		$('#save').click(function(){
			var v=$("#userform").form("validate");//校验表单数据是否为空
			if(v){
				$('#userform').submit();	
			}
...
<body class="easyui-layout" style="visibility:hidden;">
    ...
    <div region="center" style="overflow:auto;padding:5px;" border="false">
       <form id="userform" method="post" action="userLogin_add.action">
           <table class="table-edit"  width="95%" align="center">
				...
				<tr>
	           	...
	           	<tr><td>选择角色:</td><td colspan="3" id="roleTD">
	           		<script type="text/javascript">
	           		$(function(){//页面加载完毕执行此段代码
	           			$.post("roleAction_findAll.action",{},function(data){
	           				for(var i=0;i<data.length;i++){
	           					var id=data[i].id
	           					$("#roleTD").append("<input type='checkbox' id="+id+" name='roleIds' value="+id+"><label for="+id+">"+data[i].name);
	           				}
	           			});
	           		});
	           		</script>
