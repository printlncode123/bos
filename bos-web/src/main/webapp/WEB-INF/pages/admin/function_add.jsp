...
<div data-options="region:'center'">
	<form id="functionForm" method="post" action="authAction_add.action">
				<table class="table-edit" width="100%" align="center">
					<tr class="title">
						<td colspan="2">功能权限信息</td>
					</tr>
					<tr>
						<td width="200">关键字</td><!-- 这里的关键字相当于shiro在action方法上的注解名：staff-delete -->
						<td>
						...
						<td>
							...
							<input name="parentFunction.id" class="easyui-combobox" 
							 ...
							 <input class="easyui-combotree" name="parentFunction.id"
							 	data-options="url:'authAction_listajax.action'" 
							 	style="width:170px;">
						</td>
					</tr>
					<tr>
